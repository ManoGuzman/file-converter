...
class TestExtractTextFromPdf:
    """Test class for the extract_text_from_pdf function."""
...
class TestConvertPdfToJson:
    """Test class for the convert_pdf_to_json function."""
    ...
    def test_nonexistent_pdf_to_json(self):
        """Test handling of nonexistent PDF file for JSON conversion."""
        pdf_file_path = "tests/non_existent.pdf"
...
class TestExtractTablesFromPdf:
    """Test class for the extract_tables_from_pdf function."""
